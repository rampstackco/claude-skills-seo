...
1. Go to the [Security tab](https://github.com/rampstackco/claude-skills-seo/security) of this repository
...
- General feedback or suggestions on skill quality. Use [Issues](https://github.com/rampstackco/claude-skills-seo/issues) for those.
